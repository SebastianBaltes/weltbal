...
const html = `
    ...
    <a-scene 
        ...
        <a-entity foreward="event:celestial-system-ready;from:a-scene;" 
                  remove="when:celestial-system-ready; delay:300;">
            
            <a-camera active="true">
                <a-box color="black" material="shader: flat;transparent:true;opacity:0;" depth="1" height="1" width="1">
                    <a-animation foreward="event:celestial-system-ready;from:a-scene;" 
                                 begin="celestial-system-ready" 
                                 attribute="material.opacity" dur="300" to="1"></a-animation>
                </a-box>
            </a-camera>

            <a-sphere color="gray" radius="0.3" position="0 1 -2">
            </a-sphere>
            <a-text value="loding..." position="0 2 -2"></a-entity>
                ...
                <a-entity id="horizontal-reference-frame" celestial-location>
                    ...
                    <a-camera foreward="event:celestial-system-ready;from:a-scene;"
                        ...
                        <a-animation begin="celestial-system-ready" 
                                     delay="1000"
                                     attribute="active" dur="0" to="true"></a-animation>

                        <a-box color="black" material="shader: flat;transparent:true;opacity:1;" depth="1" height="1" width="1" 
                               foreward="event:celestial-system-ready;from:a-scene;"
                               remove="when:celestial-system-ready; delay:1000;">
                        
                            <a-animation begin="celestial-system-ready" 
                                         delay="400"
                                         attribute="material.opacity" dur="500" to="0"></a-animation>
                        </a-box>
                    </a-camera>
