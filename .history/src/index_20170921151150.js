...
const html = `
    ...
    <a-scene 
        ...
        antialias="true" 
        celestial-system="scale: 1; scale-time: 5000; reposition-ms: 1000; 
        ...
        <a-circle id="sun-location" color="#ff0" material="opacity:0.3;transparent:true;side:double;"  radius="0.2" celestial-location-test="body: sun; system: azimuthal; radius: 10;"></a-circle> 
        <a-circle id="moon-location" color="#fff" material="opacity:0.3;transparent:true;side:double;"  radius="0.2" celestial-location-test="body: moon; system: azimuthal; radius: 10;"></a-circle> 
