    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="horizontal-reference-frame" celestial-location>
                ...
                <a-entity position="0 0 -10" moon="textureMap:url(server/img/moon/moon1024x512.jpg); normalMap:url(server/img/moon/normal1024x512.jpg); sunLight: #sunLight; "></a-entity>
