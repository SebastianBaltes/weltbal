    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="equatorial-reference-frame" celestial-location="quaternion:false;" celestial-coordinate-transformation="from:ecliptic;to:equatorial">
                ...
                <a-sphere mixin="Sphere" color="blue" material="side:double" radius="100000000000"></a-sphere>
...
-->
            ...
            <a-entity id="moon" celestial-body="name:moon">
                <a-entity moon="textureMap:url(server/img/moon/moon1024x512.jpg); normalMap:url(server/img/moon/normal1024x512.jpg); sunLight: #sunLight; "></a-entity>
                <!--
