...
AFRAME.registerSystem('celestial-system', {
    ...
    schema: {
        ...
        scaleBodies: {type: 'number', default: 1},
    ...
    tick(time, timeDelta) {
        ...
        console.log('time?',now,this.nextRepositionTime);
        
        const ms = this.startTimeMs + (now - this.startTimeMs)  * this.data.scaleTime;
