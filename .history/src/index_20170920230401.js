...
const html = `
    ...
    <a-scene 
        ...
        <a-assets>
        <a-mixin id="Font" text="font: https://cdn.aframe.io/fonts/mozillavr.fnt;"></a-mixin>
        ...
        <a-entity id="earth-under-feet" celestial-home="body:earth;radius: 6378159.6564">
            <a-sphere id="earth-dummy" segments-width="100" segments-height="100" color="darkblue" material="transparent:true;opacity:0.5;side:double" radius="6378159.6564"></a-sphere>
    <!--
            <a-sphere id="inner-earth-core" segments-width="100" segments-height="100" color="white" material="side:double" radius="1230000"></a-sphere>
