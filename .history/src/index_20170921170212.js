...
const html = `
    ...
    -->
        ...
        <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:horizontal;to:equatorial">
            <a-circle id="andromeda-location" color="#0ff" material="opacity:0.5;transparent:true;side:double;"  radius="1000" spherical-coords="longitude: 28.781666666666666; latitude: 34.25; radius: 100000;" ></a-circle> 
...
-->            
            ...
            <a-entity id="galactic-reference-frame" celestial-coordinate-transformation="from:equatorial;to:galactic">
                <a-circle id="andromeda-location--gal" color="#aff" material="opacity:0.3;transparent:true;side:double;"  radius="1500" spherical-coords="longitude: 121.1743; latitude: -21.573; radius: 100000;" ></a-circle> 
            <!--
