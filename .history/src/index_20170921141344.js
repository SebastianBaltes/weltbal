...
const html = `
    ...
    <a-scene 
        ...
        <a-circle id="sun-location" color="#f00" material="opacity:0.5;transparent:true;side:double;"  radius="10" spherical-coords="longitude: 86.40036789250848, latitude: -1.6347759189354178; radius: 10;" ></a-circle> 
