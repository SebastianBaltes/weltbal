...
const html = `
    ...
    <a-scene 
        antialias="true" 
        celestial-system="scale-time: 0; reposition-ms: 100; 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="sun" celestial-body="sun"><a-sphere mixin="Sphere" color="yellow" material="side:double" radius="695700000" scale="10 10 10"></a-sphere></a-entity>
            ...
            <a-entity id="moon" celestial-body="moon">
                <a-sphere  mixin="Sphere" color="white" material="src: url(server/img/planets/moonmap4k.jpg); displacementScale: 100000; displacementMap: url(server/img/planets/marsbump1k.jpg); side:double" radius="1737000" scale="40 40 40"></a-sphere>
