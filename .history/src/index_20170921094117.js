    ...
    return `
        <a-entity id="${id}">
            ...
            ${_.range(0,359.999,stepLongitude).map(v=>
                `<a-entity text="value: ${(v*maxLongitude/360)+longitudeUnit}; ${textSettings}" mixin="Font" spherical-coords="longitude: ${v}; latitude: 0; radius: ${radius};"></a-entity>`
            ).join('')}
            ...
            ${_.without(_.range(-80,80.001,10),0).map(v=>
                `<a-entity text="value: ${v}; ${textSettings}" mixin="Font" spherical-coords="longitude: 0; latitude: ${v}; radius: ${radius}"></a-entity>`    
            ).join('')}
        </a-entity>
    `;
};
...
const html = `
    ...
    -->
        ...
        <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:horizontal;to:equatorial">
            ...
            <a-entity id="universeSphere" healpix-sphere="radius: 1000000000000000000; detail: 3" celestial-coordinate-transformation="from:equatorial;to:galactic"></a-entity>
 ...
 -->
        ...
        <a-entity id="ecliptic-reference-frame" move-me-so-that="my:#earth-in-solar-system;is-at:#earth-under-feet">
            ...
            <a-entity id="sun" celestial-body="sun"><a-sphere mixin="Sphere" color="yellow" material="side:double" radius="6957000000"></a-sphere></a-entity>
        
            <a-entity id="earth-in-solar-system" celestial-body="earth"></a-entity>
                                                                                                                                                        
            <a-entity id="moon" celestial-body="moon"><a-sphere  mixin="Sphere" color="white" material="side:double" radius="17370000"></a-sphere></a-entity>
...
const setHips = (hips) => {
    ...
    universeSphere.setAttribute('healpix-sphere','urlpattern',hips.folder+'/128/#.jpg');
