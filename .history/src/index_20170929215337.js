    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="horizontal-reference-frame" celestial-location>
                ...
                <a-entity position="0 0 -3" moon="textureMap:url(server/img/moon/moon1024x512.jpg); normalMap:url(server/img/moon/normal1024x512.jpg); sunLight: #sunLight; "></a-entity>

                <a-entity id="sunLight" light="type: point; color: #FFF; intensity: 1"
                          spherical-coords="longitude: 0; latitude: 0; radius: 2;"
                          animation="property: spherical-coords.longitude; loop: true; easing: linear; dur: 5000; from: 0; to: 360;" >                          
                </a-entity>
...
-->
            ...
            <a-entity id="moon" celestial-body="name:moon">
                ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:false, radius: 1})}
            </a-entity>
