...
const html = `
    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="equatorial-reference-frame" celestial-location celestial-coordinate-transformation="from:ecliptic;to:equatorial">
            
                <a-entity stars="size: -1; src: url(server/data/milkyway.json); texture: url(server/jsorrery/img/star.png);"></a-entity>
