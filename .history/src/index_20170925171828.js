...
const html = `
    ...
    <a-scene 
        ...
        <a-entity foreward="event:celestial-system-ready;from:a-scene;" 
            ...
            <a-text value="WELTBAL" align="center" width="1" position="0 1.4 -2"></a-entity>
            
            <a-entity light="type: point; color: #FFF; intensity: 0" position="0 5 -10"
                      foreward="event:celestial-system-ready;from:a-scene;" 
                      animation__in="property: light.intensity; dur: 1000; easing: easeOutQuad; loop: false; from: 0; to: 1;"
                      animation__out="startEvents: celestial-system-ready; property: light.intensity; dur: 1000; easing: easeOutQuad; loop: false; from: 1; to: 0;">
            </a-entity>
...
-->            
            ...
            <a-entity id="sun" celestial-body="sun">
                ...
                <a-entity light="type: ambient; color: #aaa; intensity: 0" 
                          foreward="event:celestial-system-ready;from:a-scene;delay:3000;"
                          animation="startEvents: celestial-system-ready; property: light.intensity; delay: 4000; dur: 1000; easing: easeOutQuad; loop: false; from: 0; to: 1;" >
                </a-entity>
            ...
            <a-entity id="earth" celestial-body="earth">
                ...
                <a-entity id="horizontal-reference-frame" celestial-location>
                    ...
                    <a-camera foreward="event:celestial-system-ready;from:a-scene;"
                        ...
                        <a-box color="black" material="shader:flat;transparent:true; opacity:1; side: double;" depth="5" height="5" width="5" 
                               foreward="event:celestial-system-ready;from:a-scene;delay:1000;"
                               remove="when:celestial-system-ready; delay:3010;"
                               animation="startEvents: celestial-system-ready; property: material.opacity; dur: 3000; easing: easeOutQuad; loop: false; from: 1.0; to: 0.0;">
                        </a-box>
                    </a-camera>
