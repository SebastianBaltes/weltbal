...
let gridId = 0;
const coordinateGrid = ({id='grid'+(girdId++),longitudeUnit='°', longitudeClockwise=false, color='#aaa',opacity=0.1,radius=100,fontWidth=50}) => {
    ...
    return `
        <a-entity id="${id}">
            ...
            <a-entity axial-helper="size: ${2*radius};"></a-entity>    
...
-->
   ...
   -->
        ...
        <a-entity id="ecliptic-reference-frame" move-me-so-that="my:#earth-in-solar-system;is-at:#earth-under-feet">
            ...
            <a-entity id="sunNorth"><a-sphere mixin="Sphere" position="0 69570000000 0" color="blue" material="side:double" radius="695700000"></a-sphere></a-entity>
