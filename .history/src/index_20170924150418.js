...
const html = `
    ...
    <a-scene 
        ...
        celestial-system="scale-time: 0; reposition-ms: 1000; 
                          time: 2017-09-24T15:04:00.000+02:00;
                          longitude: 0; latitude: 0; 
                          altitude: 10000000; radius: 6378159.6564;"
        >

        <!--

        latitude: 51.6802; longitude: 7.8134;
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity celestial-test="body: sun; color: #ff0; az: +209°06'12.9'' / +89°59'51.7''; radec: +280°22'51.1'' / -0°00'02.7''"></a-entity>
            ...
            <a-entity celestial-test="body: jupiter; color: #00f; az: +257°18'01.3'' / +29°46'36.3''; radec: +222°37'52.5'' / +4°51'16.6''"></a-entity>
            <a-entity celestial-test="body: mars; color: #00f; az: +257°18'01.3'' / +29°46'36.3''; radec: +222°37'52.5'' / +4°51'16.6''"></a-entity>
...
-->            
            ...
            <a-entity id="jupiter" celestial-body="jupiter">
                ${coordinateGrid({longitudeUnit:'°',color:'#00f',longitudeClockwise:true, radius: 69570000000})}
                <a-sphere mixin="Sphere" color="blue" material="side:double" radius="695700000" scale="4 4 4"></a-sphere>
            </a-entity>
