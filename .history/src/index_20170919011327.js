...
const html = `
    ...
    <a-scene 
        ...
        <a-entity id="CardinalDirections" celestial-coordinate-transformation="from:vr;to:horizontal;">
            ...
            <a-text value="W" spherical-coords="longitude: 90;" mixin="CardinalCoordsSchema"></a-text>
            <a-text value="S" spherical-coords="longitude: 180;" mixin="CardinalCoordsSchema"></a-text>
            <a-text value="E" spherical-coords="longitude: 270;" mixin="CardinalCoordsSchema"></a-text>
        </a-entity>
