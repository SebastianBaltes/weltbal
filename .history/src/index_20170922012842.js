...
const html = `
    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" move-me-so-that="my:#earth-in-solar-system;is-at:#earth-under-feet">
            ...
            <!-- world position from: parent matrix berücksichtigen!! -->
            <a-entity id="equatorial-reference-frame" celestial-coordinate-transformation="from:ecliptic;to:equitorial" world-position-from="a-camera">
            
                ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:false, radius: 100})}
