    ...
    return `
        <a-entity id="${id}">
            ...
            ${_.range(0,359.999,stepLongitude).map(v=>
                `<a-entity text="value: ${(v*maxLongitude/360)+longitudeUnit}; ${textSettings}" mixin="Font" spherical-coords="longitude: ${longitudeClockwise?(360-v)%360:v}; latitude: 0; radius: ${radius};"></a-entity>`
            ).join('')}
...
const html = `
    ...
    <a-scene 
        ...
        ${coordinateGrid({longitudeUnit:'°',color:'#fff'})}
