    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="moon" celestial-body="moon">
                <a-sphere  mixin="Sphere" color="white" material="src: url(server/img/planets/moonmap4k.jpg); normalMap: url(server/img/planets/marsbump1k.jpg); side:double" radius="1737000" scale="3 3 3"></a-sphere>
