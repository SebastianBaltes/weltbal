    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:ecliptic;to:equatorial">
                ...
                <a-entity stars="radius: 1; src: url(server/data/milkyway_heasarc_204k.json); texture: url(server/jsorrery/img/star2.png);"></a-entity>
            ...
            <a-entity id="earth" celestial-body="name:earth; scale:false; perspective: false; ">
