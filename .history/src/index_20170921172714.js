...
const html = `
    ...
    <a-scene 
        ...
        antialias="true" 
        celestial-system="scale: 1; scale-time: 1; reposition-ms: 60000; 
                          time: 2017-09-18 07\:10\:37+02; latitude: 51.6802; longitude: 7.8134; altitude: 0; north: 0;"
        >

        <!-- 
            time: 2017-09-18 07\:10\:56+02; latitude: 51.4463; longitude: 7.52045;
            Sonne liegt im Osten genau mittig auf dem Horizonth

            console.log('m31 eq',["+27°50'56.9''","+33°20'55.0''"].map(x=>CoordinateParser.parse(x)).join('  '));
            console.log('m31 az',["+287°36'39.9''","+41°33'43.6''"].map(x=>CoordinateParser.parse(x)).join('  '));
        ...
        <a-circle id="sun-location" color="#ff0" material="opacity:0.3;transparent:true;side:double;"  radius="2000" celestial-location-test="body: sun; system: azimuthal; radius: 100000;"></a-circle> 
        <a-circle id="moon-location" color="#fff" material="opacity:0.3;transparent:true;side:double;"  radius="2000" celestial-location-test="body: moon; system: azimuthal; radius: 100000;"></a-circle> 
        <a-circle id="m31-location" color="#f77" material="opacity:0.2;transparent:true;side:double;"  radius="3000" celestial-location-test="body: m31; system: azimuthal; radius: 100000;"></a-circle> 
        <a-circle id="m31-location-fix" color="#0f0" material="opacity:0.2;transparent:true;side:double;"  radius="4000" spherical-coords="longitude: 288.265; latitude: 42.2766; radius: 100000; longitudeClockwise:true;"></a-circle> 
    ...
    -->
        ...
        <a-circle id="andromeda-location" color="#f00" material="opacity:0.5;transparent:true;side:double;"  radius="2000" spherical-coords="longitude: 10.6847; latitude: 41.39166; radius: 100000;" ></a-circle> 
...
-->            
            ...
            <a-entity id="galactic-reference-frame" celestial-coordinate-transformation="from:equatorial;to:galactic">
                <a-circle id="andromeda-location-gal" color="#f00" material="opacity:1;transparent:true;side:double;"  radius="1000" spherical-coords="longitude: 121.1743; latitude: -21.573; radius: 100000;" ></a-circle> 
            <!--
