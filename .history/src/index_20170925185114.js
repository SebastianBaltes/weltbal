...
const html = `
    ...
    <a-scene 
        ...
        <a-entity foreward="event:celestial-system-ready;from:a-scene;" 
                  remove="when:celestial-system-ready; delay:1010;">
            ...
            <a-text value="WELTBAL" align="center" width="0.7" position="0 1.4 -2" rotation="90 0 0" animation__in="property: rotation; delay: 1000; dur: 500; easing: easeOutQuad; from: 90 0 0; to: 0 0 0;"></a-entity>
