...
const html = `
    ...
    <a-scene 
        ...
        <a-circle id="m31-location" color="#fff" material="opacity:0.3;transparent:true;side:double;"  radius="2000" celestial-location-test="body: m31; system: azimuthal; radius: 100000;"></a-circle> 
