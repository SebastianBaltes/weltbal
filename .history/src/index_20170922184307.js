...
//  curveSegments: 6;
    ...
    return `
        <a-entity id="${id}">
            <a-entity axis-helper="size: ${0.5*radius};"></a-entity>    
    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            -->
                ...
                <a-entity id="horizontal-reference-frame" celestial-location="longitude: 0; latitude: 0; north: 0; altitude: 100000; radius: 6378159.6564;">
