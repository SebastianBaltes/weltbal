...
const html = `
    ...
    <a-scene 
        ...
        <a-circle id="sun-location" color="#f00" material="opacity:0.3;transparent:true;side:double;"  radius="0.2" spherical-coords="longitude: 86.40036789250848, latitude: -1.6347759189354178; radius: 10;" ></a-circle> 
        <a-circle id="moon-location" color="#fff" material="opacity:0.3;transparent:true;side:double;"  radius="0.2" spherical-coords="latitude: 23.241867418085747, longitude: 91.94773358874073; radius: 10;" ></a-circle> 
