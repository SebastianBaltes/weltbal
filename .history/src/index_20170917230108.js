...
const html = `
    ...
    <a-scene 
        ...
        <a-entity id="earth-under-feet" celestial-home="body:earth;radius: 6378159.6564">
            <a-sphere id="earth-dummy" segments-width="100" segments-height="100" color="darkblue" material="transparent:true;opacity:0.5;side:double" radius="6336000"></a-sphere>
    <!--
