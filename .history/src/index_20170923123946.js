...
const html = `
    ...
    <a-scene 
        ...
        celestial-system="scale-time: 0; reposition-ms: 1000; 
                          time: 2000-01-01T13\:03\:21+01\:00; latitude: 0; longitude: 0; altitude: 0; north: 0;"
        >
        ...
        <a-entity celestial-test="body: sun; color: #ff0; radec: 18h44m58.50s / -23°02'15.0''; az: +180°00'10.3'', +66°58'04.2''"></a-entity>
...
-->            
            ...
            <a-entity id="earth" celestial-body="earth">
                ...
                <a-entity id="horizontal-reference-frame" celestial-location="longitude: 0; latitude: 0; north: 0; altitude: 1; radius: 6378159.6564;">
            ...
            <a-entity id="moon" celestial-body="moon">
                <a-sphere  mixin="Sphere" color="white" material="src: url(server/img/planets/moonmap4k.jpg); normalScale: 1000; normalMap: url(server/img/planets/marsbump1k.jpg); side:double" radius="1737000" scale="40 40 40"></a-sphere>
