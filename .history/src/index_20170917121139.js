...
const html = `
    ...
    <a-scene 
        ...
        antialias="true" 
        celestial-system="scale: 1; scale-bodies: 1; scale-time: 500; reposition-ms: 60000; 
...
-->
        ...
        <a-entity id="ecliptic-reference-frame" move-me-so-that="my:#earth-in-solar-system;is-at:#earth-under-feet">
            ...
            <a-entity id="moon" celestial-body="moon"><a-sphere segments-width="100" segments-height="100" color="white" material="side:double" radius="1737000000"></a-sphere></a-entity>
