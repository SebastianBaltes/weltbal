...
const html = `
    ...
    <a-scene 
        ...
        <a-circle id="m31-location" color="#f00" material="opacity:0.1;transparent:true;side:double;"  radius="3000" celestial-location-test="body: m31; system: azimuthal; radius: 100000;"></a-circle> 
