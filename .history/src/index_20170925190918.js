...
const html = `
    ...
    <a-scene 
        ...
        <a-entity foreward="event:celestial-system-ready;from:a-scene;" 
                  remove="when:celestial-system-ready; delay:1000;">
            ...
            <a-sphere color="gray" radius="0.3" position="0 1 -2"></a-sphere>
            <a-text value="WELTBAL" align="center" width="0.7" position="0 1.4 -2" rotation="90 0 0" animation__in="property: rotation; delay: 1500; dur: 500; easing: easeOutQuad; from: 90 0 0; to: 0 0 0;"></a-entity>
            
            <a-entity light="type: point; color: #FFF; intensity: 0" position="0 5 -10"
                      foreward="event:celestial-system-ready;from:a-scene;" 
                      animation__in="property: light.intensity; delay: 500; dur: 2000; easing: easeOutQuad; from: 0; to: 1;"
                      animation__out="startEvents: celestial-system-ready; property: light.intensity; dur: 1000; easing: easeOutQuad; from: 1; to: 0;">
            </a-entity>
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity celestial-test="body: sun; color: #ff0; az: 2h54m50.61s / +89°15'51.4''; radec: +280°22'51.1'' / -0°00'02.7''"></a-entity>
...
-->            
            ...
            <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:ecliptic;to:equatorial">
                ...
                <a-entity stars="radius: 100000000; src: url(server/data/milkyway_heasarc_204k.json); texture: url(server/jsorrery/img/star2.png);"></a-entity>
            ...
            <a-entity id="sun" celestial-body="sun">
                ...
                <!-- 
                ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:true, radius: 69570000000})}
                -->
                ...
                <a-entity light="type: ambient; color: #aaa; intensity: 0" 
                          foreward="event:celestial-system-ready;from:a-scene;delay:1000;"
                          animation="startEvents: celestial-system-ready; property: light.intensity; dur: 1000; easing: easeOutQuad; from: 0; to: 1;" >
                </a-entity>
                <a-entity light="type: point; color: #FFF; intensity: 0" position="0 0 0"
                          foreward="event:celestial-system-ready;from:a-scene;delay:1000;"
                          animation="startEvents: celestial-system-ready; property: light.intensity; dur: 1000; easing: easeOutQuad; from: 0; to: 1;" >                          
                </a-entity>
            ...
            <a-entity id="earth" celestial-body="earth">
                ...
                ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:true, radius: 6078159.6564})}

                <a-entity id="horizontal-reference-frame" celestial-location>

                    <a-camera foreward="event:celestial-system-ready;from:a-scene;"
                              active="false" 
                              change-attribute="when:celestial-system-ready; attribute:active; value:true; delay:1000"
                              near="0.1" far="10000000000000000000" renderer-parameter-patch="logarithmicDepthBuffer: true">

                        <a-box color="black" material="shader:flat;transparent:true; opacity:1.0; side: double;" depth="5" height="5" width="5" 
                               foreward="event:celestial-system-ready;from:a-scene;delay:1000;as:ready"
                               remove="when:ready; delay:3010;"
                               animation="startEvents: ready; property: material.opacity; dur: 3000; easing: easeOutQuad; from: 1.0; to: 0.0;">
                        </a-box>
                        
                    </a-camera>
          
                    <a-entity sound="src: url(server/sound/stellar/MindsEye__Dr_Rinkel_-_Stellar.mp3); autoplay: true; distanceModel: linear;"></a-entity>
            ...
            <a-entity id="moon" celestial-body="moon">
                ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:false, radius: 37370000})} 
            </a-entity>
