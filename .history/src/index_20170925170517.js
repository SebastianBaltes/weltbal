    ...
    <a-scene 
        ...
        <a-entity foreward="event:celestial-system-ready;from:a-scene;" 
            ...
            <a-entity light="type: point; color: #FFF; intensity: 0" position="0 5 -10"
                    ...
                    <a-animation attribute="light.intensity" dur="1000" from="0" to="1"></a-animation>

                    <a-animation begin="celestial-system-ready" 
                                 attribute="light.intensity" dur="1000" from="1" to="0"></a-animation>
            </a-entity>
            ...
            <a-entity id="earth" celestial-body="earth">
                ...
                <a-entity id="horizontal-reference-frame" celestial-location>
                    ...
                    <a-camera foreward="event:celestial-system-ready;from:a-scene;"
                                active="false" 
                                change-attribute="when:celestial-system-ready;attribute:active;value:true;delay:800"
                        ...
                        <a-box color="black" material="shader:flat;transparent:true; opacity:1; side: double;" depth="5" height="5" width="5" 
                                foreward="event:celestial-system-ready;from:a-scene;"
                                remove="when:celestial-system-ready; delay:50000;"
                                animation="startEvents: celestial-system-ready; property: material.opacity; dur: 3000; easing: easeOutQuad; loop: false; from: 0.0; to: 1.0; delay: 1000;">
