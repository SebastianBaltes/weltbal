...
const html = `
    ...
    <a-scene 
        antialias="true" 
        celestial-system="scale-time: 1000000; reposition-ms: 100; 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="earth" celestial-body="earth">
                ...
                <a-entity id="horizontal-reference-frame" celestial-location="longitude: 0; latitude: 90; north: 0; altitude: 1000000; radius: 6378159.6564;">

                    ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:false, radius: 10000000000})}
