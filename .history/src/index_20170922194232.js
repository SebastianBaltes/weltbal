    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:ecliptic;to:equatorial">
                ...
                ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:false, radius: 100000000000})}
            ...
            <a-entity id="earth" celestial-body="earth">
                ...
                ${coordinateGrid({longitudeUnit:'°',color:'#00f',opacity:0.8,longitudeClockwise:false, radius: 6378159.6564})}
            ...
            -->
                ...
                <a-entity id="horizontal-reference-frame" celestial-location="longitude: 90; latitude: 0; north: 0; altitude: 10000000; radius: 6378159.6564;">
            ...
            <a-entity id="moon" celestial-body="moon">
                <a-sphere  mixin="Sphere" color="white" material="side:double" radius="1737000"></a-sphere>
