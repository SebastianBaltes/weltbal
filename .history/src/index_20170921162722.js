...
const html = `
    ...
    <a-scene 
        ...
        antialias="true" 
        celestial-system="scale: 1; scale-time: 1; reposition-ms: 1000; 
                          time: 2017-09-18 07\:10\:56+02; latitude: 51.4463; longitude: 7.52045; altitude: 0; north: 0;"
        >

        <!-- 
            time: 2017-09-18 07\:10\:56+02; latitude: 51.4463; longitude: 7.52045;
            Sonne liegt im Osten genau mittig auf dem Horizonth
            ra/de (datum):11h43m28s/+1°47'22''
            11,7244444h 1.789444°

            m31: 
            gal: 121.1743, latitude: -21.573
            eq: +27°50'56.9'', +33°20'55.0''
            azimuth: +287°36'39.9'', +41°33'43.6''
        ...
        <a-circle id="m31-location" color="#00f" material="opacity:0.3;transparent:true;side:double;"  radius="2000" celestial-location-test="body: m31; system: azimuthal; radius: 100000;"></a-circle> 
    ...
    -->
        ...
        <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:horizontal;to:equatorial">
            ...
            <a-circle id="andromeda-location" color="#0ff" material="opacity:0.5;transparent:true;side:double;"  radius="1000" spherical-coords="longitude: 121.1743; latitude: -21.5733; radius: 100000;" ></a-circle> 
