...
const html = `
    ...
    <a-scene 
        ...
        <a-entity foreward="event:celestial-system-ready;from:a-scene;" 
                  remove="when:celestial-system-ready; delay:10000;">
            
            <a-camera active="true">

                <a-box foreward="event:celestial-system-ready;from:a-scene;" 
                       color="black" material="transparent:true; opacity:0; side: double;" depth="1" height="1" width="1">

                    <a-animation begin="celestial-system-ready" 
                                attribute="material.opacity" dur="1000" from="0" to="1"></a-animation>
                </a-box>
            </a-camera>

            <a-sphere color="gray" radius="0.3" position="0 1 -2"></a-sphere>
            <a-text value="loading..." align="center" width="1" position="0 2 -2"></a-entity>
            <a-entity light="type: point; color: #FFF; intensity: 1" position="0 5 -10"></a-entity>
            ...
            <a-entity id="earth" celestial-body="earth">
                ...
                <a-entity id="horizontal-reference-frame" celestial-location>
                    ...
                    <a-camera foreward="event:celestial-system-ready;from:a-scene;"
                        ...
                        <a-box color="black" material="transparent:true;opacity:1;side: double;" depth="1" height="1" width="1" 
                                foreward="event:celestial-system-ready;from:a-scene;"
                                remove="when:celestial-system-ready; delay:2000;">
                        
                            <a-animation begin="celestial-system-ready" 
                                        delay="1000"
                                        attribute="material.opacity" dur="1000" from="1" to="0"></a-animation>
                        </a-box>
                    </a-camera>
