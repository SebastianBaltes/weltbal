...
const html = `
    ...
    -->
        ...
        <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:horizontal;to:equatorial">
            <a-circle id="andromeda-location" color="#f00" material="opacity:0.5;transparent:true;side:double;"  radius="2000" spherical-coords="longitude: 28.781; latitude: 34.25; radius: 100000;" ></a-circle> 
