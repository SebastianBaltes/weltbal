        ...
        <a-entity foreward="event:celestial-system-ready;from:a-scene;" 
            ...
            <a-camera active="true">
                <a-box foreward="event:celestial-system-ready;from:a-scene;" 
                       color="black" material="shader: flat;transparent:true; opacity:0;" depth="1" height="1" width="1">
                    <a-animation begin="celestial-system-ready" 
                                 attribute="material.opacity" dur="3000" to="1"></a-animation>
                </a-box>
            </a-camera>

            <a-sphere color="gray" radius="0.3" position="0 1 -2">
            </a-sphere>
            <a-text value="loading..." align="center" width="1" position="0 1 -1.5"></a-entity>
