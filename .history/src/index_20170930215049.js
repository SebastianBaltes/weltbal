    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="horizontal-reference-frame" celestial-location>
                ...
                <a-camera near="0.1" far="10000000000000000000" 
                          renderer-parameter-patch="logarithmicDepthBuffer: true"
                          stereocam="eye:left;">
                </a-camera>
            ...
            <a-entity id="moon" celestial-body="name:moon;scale:50;">
            ...
            <a-entity celestial-body="name:mercury;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/mercurymap.jpg);"></a-sphere>
            </a-entity>
            <a-entity celestial-body="name:venus;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/venusmap.jpg);"></a-sphere>
            </a-entity>
            <a-entity celestial-body="name:mars;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/mars_1k_color.jpg);"></a-sphere>
            </a-entity>
            <a-entity celestial-body="name:jupiter;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/jupitermap.jpg);"></a-sphere>
            </a-entity>
            <a-entity celestial-body="name:saturn;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/saturnmap.jpg);"></a-sphere>
            </a-entity>
            <a-entity celestial-body="name:uranus;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/uranusmap.jpg);"></a-sphere>
            </a-entity>
            <a-entity celestial-body="name:neptune;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/neptunemap.jpg);"></a-sphere>
            </a-entity>
            <a-entity celestial-body="name:pluto;scale:50;">
                <a-sphere radius="1" material="shader: phong; shininess: 5; src: url(server/img/moon/plutomap1k.jpg);"></a-sphere>
            </a-entity>
