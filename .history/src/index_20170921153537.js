...
const html = `
    ...
    -->
        ...
        <a-entity id="equatorial-reference-frame" world-position-from="a-camera" celestial-coordinate-transformation="from:horizontal;to:equatorial">
            ...
            <a-circle id="andromeda-location" color="#0ff" material="opacity:0.5;transparent:true;side:double;"  radius="1000" spherical-coords="longitude: 121.1743; latitude: -21.5733; radius: 1000;" ></a-circle> 
