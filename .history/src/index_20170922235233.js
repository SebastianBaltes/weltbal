    ...
    <a-scene 
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="moon" celestial-body="moon">
                <a-sphere  mixin="Sphere" color="white" material="src: url(server/img/planets/moonmap4k.jpg); displacementMap: url(server/img/planets/marsbump1k.jpg); side:double" radius="1737000" scale="40 40 40"></a-sphere>
