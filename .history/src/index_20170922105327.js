...
const html = `
    ...
    <a-scene 
        ...
        <a-entity id="earth-under-feet">
            ${coordinateGrid({longitudeUnit:'°',color:'#00f',longitudeClockwise:false, radius: 100000000000000})}
...
-->
            <a-entity id="horizontal-reference-frame" celestial-location="longitude: 0; latitude: -90; north: 0; altitude: 0; radius: 6378159.6564;">
