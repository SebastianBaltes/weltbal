    ...
    init() {
        ...
        if ("geolocation" in navigator) {
            navigator.geolocation.getCurrentPosition(position => {
                ...
                if (position.coords) {
                    entity.setAttribute('celestial-system','longitude',position.coords.longitude || 0);
                    entity.setAttribute('celestial-system','latitude',position.coords.longitlatitudeude || 0);
                    entity.setAttribute('celestial-system','altitude',position.coords.altitude || 0);
                }

                if (position.webkitCompassHeading!=null) {
                    const north = position.webkitCompassHeading || 0;
                    entity.setAttribute('celestial-system','north',position.webkitCompassHeading || 0);
                }
            ...
            if ('ondeviceorientationabsolute' in window) {
                function listener(orientation) {
                    ...
                    entity.setAttribute('celestial-system','north',orientation.alpha || 0);
                }
