...
AFRAME.registerComponent('celestial-location-test', {
    ...
    init()  {
        ...
        frames.forEach(f=>{
            ...
            <a-circle spherical-coords="longitude: 288.265; latitude: 42.2766; radius: 100000; longitudeClockwise:true;"></a-circle> 
            ...
            $(f.frame).append(
                $(`<a-plane color="${d.color}" 
                            ...
                            width="${1.7*f.radius}" 
                            height="${1.7*f.radius}" 
                            spherical-coords="longitude: 288.265; latitude: 42.2766; radius: 100000; longitudeClockwise:true;"
                            ></a-circle>`)
            );
        });
