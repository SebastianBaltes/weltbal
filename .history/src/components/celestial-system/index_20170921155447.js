        ...
        if (body) {
            ...
            if (objectEl) {
                ...
                return {
                    ...
                    galactic: spherical(gal'actic,true),
                };
            }            
        } else {
            if (objectName=='m31') {
...
console.log('m31 eq',["+27°50'56.9''","+33°20'55.0''"].forEach(CoordinateParser.parse).join('  '));
console.log('m31 az',["+287°36'39.9''","+41°33'43.6''"].forEach(CoordinateParser.parse).join('  '));
