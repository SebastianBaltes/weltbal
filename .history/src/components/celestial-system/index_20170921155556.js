...
console.log('m31 eq',["+27°50'56.9''","+33°20'55.0''"].forEach(x=>CoordinateParser.parse(x)).join('  '));
console.log('m31 az',["+287°36'39.9''","+41°33'43.6''"].forEach(x=>CoordinateParser.parse(x)).join('  '));
