...
export default class Body {
	...
	applyTransformationTo(object3D) {
        ...
        console.log(this.name,this.rotation);
        const r = (((this.rotation*180/Math.PI) % 360 + 360) % 360) * Math.PI/180;
        console.log(this.name,r);
        const rotation = new Quaternion().setFromEuler(new Euler(0, r, 0, 'XYZ'));
