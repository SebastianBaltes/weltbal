...
export default class Body {
	...
	applyTransformationTo(object3D) {
        ...
        const rotation = new Quaternion().setFromEuler(new Euler(this.rotation, 0, 0, 'XYZ'));
		object3D.quaternion.copy(new Quaternion()).multiply(rotation).multiply(this.tilt);
	}
