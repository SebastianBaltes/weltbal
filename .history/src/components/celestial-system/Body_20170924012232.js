...
export default class Body {
	...
	applyTransformationTo(object3D) {
        ...
        const rotation = new Quaternion().setFromEuler(new Euler(0, 0, this.rotation, 'XYZ'));
        object3D.quaternion.copy(new Quaternion()).multiply(this.tilt).multiply(rotation);
        console.log(this.name,JSON.stringify(this.tilt));
	}
