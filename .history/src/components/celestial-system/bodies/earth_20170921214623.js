...
//1 = 1 rotation
const baseRotation = (((J2000Date) / 1000) / (YEAR * DAY));
// let testTilt = 0;
...
export const earth = {
	...
	baseMapRotation: THREE.Math.degToRad(0), //THREE.Math.degToRad(-10/360), // THREE.Math.degToRad(196.637)
	...
	getTilt(xCorrection = 0) {
		...
		return new THREE.Euler(xCorrection - this.tilt * DEG_TO_RAD, 0, -precession, 'ZYX');
	},
