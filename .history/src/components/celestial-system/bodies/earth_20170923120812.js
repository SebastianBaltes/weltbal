...
export const earth = {
	...
	get baseMapRotation() {
		return THREE.Math.degToRad(self.EARTH_ROTATION);
	},

	// baseMapRotation: THREE.Math.degToRad(-76.614), //THREE.Math.degToRad(-9.8), //THREE.Math.degToRad(-10/360), // THREE.Math.degToRad(196.637)
	...
	getTilt() {
		...
		return new THREE.Euler(0 - this.tilt * DEG_TO_RAD, 0, -precession, 'ZYX');
	},
