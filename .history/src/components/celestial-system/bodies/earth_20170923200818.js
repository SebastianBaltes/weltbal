...
export const earth = {
	...
	baseMapRotation: THREE.Math.degToRad(30.447),
	...
	getTilt() {
		...
		return new THREE.Euler(0 - this.tilt * DEG_TO_RAD, 3/4*CIRCLE, -precession, 'ZYX');
		// return new THREE.Euler(0 - this.tilt * DEG_TO_RAD, 0,0, 'ZYX');
	},
