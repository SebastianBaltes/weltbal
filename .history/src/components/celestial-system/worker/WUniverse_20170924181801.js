...
export default class WUniverse {
    ...
    setEquatorialCoordinateSystem() {
        ...
        this.updateBodies();
        const earth = this.getBody('earth');
        const rotation = new Quaternion().setFromEuler(new Euler(0, earth.rotation, 0,  'XYZ'));
        this.earthOrientationVernalEquinoxJ2000 = object3D.quaternion.copy(this.earth).multiply(rotation);
        console.log('earthOrientationVernalEquinoxJ2000',this.earthOrientationJ2000);
    }
