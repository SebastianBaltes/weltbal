...
import {KM, CIRCLE} from './constants';
...
const celestialSystem = {
    ...
    // orientation of earth on reference time J2000
    // calculated from WUniverse.setJ200RotationOfEarth()
    rotationEclipticToEquatorial: new THREE.Quaternion(
        0.13088303296041612,0.630924211039771,
        0.15533244564637985,-0.7487830813636481),
    ...
    getObjectPositionInfo(objectName) {
        ...
        const toCoordinates = eclipticPosition => ({
            azimuthal: transform('#horizontal-reference-frame',false,eclipticPosition),
