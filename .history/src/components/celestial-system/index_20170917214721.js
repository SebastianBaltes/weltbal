...
AFRAME.registerComponent('celestial-system', {
    ...
    calculateCurrentDate() {
        ...
        const time = new Date(Date.parse(this.data.time).getTime() + deltaFromDataTimeMs);
...
export default {
    injectWhenReady(instance) {
        const celestialSystem = ()=>document.querySelector('a-scene').components['celestial-system'];
        waitUntil(() => {
