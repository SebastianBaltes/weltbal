...
const celestialSystem = {
    ...
    getObjectPositionInfo(objectName) {
        ...
        const transform = (frameId,cw,eclipticPosition) => {
            ...
            const worldQuaternion = frame.getWorldQuaternion();
        ...
        if (body) {
            return toCoordinates(body.getWorldPosition().clone());
        } else {
            if (objectName=='m31') {
                ...
                const inverseWM = new Matrix4().getInverse(frame.matrixWorld,true);
