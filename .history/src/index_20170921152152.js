...
const html = `
    ...
    <a-scene 
        ...
        <a-circle id="sun-location" color="#ff0" material="opacity:0.3;transparent:true;side:double;"  radius="2000" celestial-location-test="body: sun; system: azimuthal; radius: 10000;"></a-circle> 
        <a-circle id="moon-location" color="#fff" material="opacity:0.3;transparent:true;side:double;"  radius="2000" celestial-location-test="body: moon; system: azimuthal; radius: 10000;"></a-circle> 
