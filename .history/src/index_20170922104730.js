...
const html = `
    ...
    <a-scene 
        ...
        <a-entity id="earth-under-feet">
            ...
            <a-entity id="horizontal-reference-frame" celestial-location="longitude: 0; latitude: 90; north: 0; altitude: 2; radius: 6378159.6564;">
   ...
   -->
        ...
        <a-entity id="ecliptic-reference-frame" move-me-so-that="my:#earth-in-solar-system;is-at:#earth-under-feet">
            ...
            <a-entity id="earth-in-solar-system" celestial-body="earth">
                <a-sphere id="earth-dummy2" mixin="Sphere" color="cyan" material="transparent:true;opacity:1;side:double" radius="6378159.6564"></a-sphere>            
            </a-entity>
