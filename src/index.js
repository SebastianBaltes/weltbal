...
<!--
                           ...
                           longitude: 7.8134; latitude: 51.6802; 
                           longitude: 0; latitude: 23.4392911; 
-->
        <a-assets>
        ...
        <a-entity id="ecliptic-reference-frame" >
            ...
            <a-entity id="horizontal-reference-frame" celestial-location>
                ...
                ${coordinateGrid({longitudeUnit:'°',color:'#fff',longitudeClockwise:true, radius: 1000000000})}
            ...
            <a-entity id="sun" celestial-body="name:sun;scale:1;">
            ...
            <a-entity id="moon" celestial-body="name:moon;scale:1;">
