...
AFRAME.registerComponent('animation', {
  ...
  addEventListeners: function () {
    ...
    data.startEvents.map(function (eventName) {
      el.addEventListener(eventName, ()=>self.playAnimation());
    });
    data.pauseEvents.map(function (eventName) {
      el.addEventListener(eventName, ()=>self.pauseAnimation());
    });
    data.resumeEvents.map(function (eventName) {
      el.addEventListener(eventName, ()=>self.resumeAnimation());
    });
    data.restartEvents.map(function (eventName) {
      el.addEventListener(eventName, ()=>self.restartAnimation());
    });
  },
